...
with open('SJCBCtraintest.csv','r') as f:
...
with open('SJCBChold.csv','r') as f:
    reading = csv.reader(f,delimiter=',')
    i = 0
    max_row = 0
    max_col = 0
...
model.fit(sparse_mat_train, y_vec_train, validation_data = (sparse_mat_test,y_vec_test), epochs = 10, callbacks= [call_func])
