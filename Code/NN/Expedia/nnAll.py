...
with open('SJCEHtraintest10re.csv','r') as f:
...
# with open('SJCEHhold10re.csv','r') as f:
    reading = csv.reader(f,delimiter=',')
    i = 0
    max_row = 0
    max_col = 0
...
model.fit(sparse_mat_train, y_vec_train, validation_data = (sparse_mat_test,y_vec_test), nb_epoch=20,callbacks= [call_func])
