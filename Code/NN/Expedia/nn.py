...
y_vec = []
label = 2
with open('EHtrain10re.csv','r') as f1:
...
with open('EHtest10re.csv','r') as f1:
	reading1 = csv.reader(f1,delimiter = ',')
	i = 0
	for row in reading1:
		if i == 0:
...
with open('SJCnor1EHtraintest10re.csv','r') as f:
...
#############################################################################################
y_vec_hold = []
with open('EHhold10re.csv','r') as f1:
	reading1 = csv.reader(f1,delimiter = ',')
	i = 0
	for row in reading1:
		if i == 0:
...
with open('SJCnor1EHhold10re.csv','r') as f:
    reading = csv.reader(f,delimiter=',')
    i = 0
    max_row = 0
    max_col = 0
...
sparse_mat_train = sparse_mat[:471071,:]
y_vec_train = y_vec[:471071]
sparse_mat_test = sparse_mat[471071:,:]
y_vec_test = y_vec[471071:]
start = time.time()
