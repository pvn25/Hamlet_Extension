...
label = 1
y_vec = []
with open('WTtrain_new.csv','r') as f1:
...
with open('WTtest_new.csv','r') as f1:
	reading1 = csv.reader(f1,delimiter = ',')
	i = 0
	for row in reading1:
		if i == 0:
...
with open('SWTtraintest.csv','r') as f:
...
#############################################################################################
y_vec_hold = []
with open('WThold_new.csv','r') as f1:
	reading1 = csv.reader(f1,delimiter = ',')
	i = 0
	for row in reading1:
		if i == 0:
...
sparse_mat_train = sparse_mat[:210785,:]
y_vec_train = y_vec[:210785]
sparse_mat_test = sparse_mat[210785:,:]
y_vec_test = y_vec[210785:]
start = time.time()
