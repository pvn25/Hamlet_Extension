...
with open('SCAMLtraintest.csv','r') as f:
...
#############################################################################################
y_vec_hold = []
with open('MLhold_new1.csv','r') as f1:
	reading1 = csv.reader(f1,delimiter = ',')
	i = 0
	for row in reading1:
		if i == 0:
...
with open('SCAMLhold.csv','r') as f:
    reading = csv.reader(f,delimiter=',')
    i = 0
    max_row = 0
    max_col = 0
...
adam_op = keras.optimizers.Adam(lr=0.0001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0)
